(function ($) {
    ...
    function wrapTable(table, options) {
        ...
        var headerTable = $('<table style="table-layout:fixed;width:auto;margin-bottom:0; border-spacing: 0;" class="jqstb-header-table ' + existingClasses + '"><thead><tr><td></td></tr></thead></table>'),

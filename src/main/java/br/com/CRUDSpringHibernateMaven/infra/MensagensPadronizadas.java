...
public class MensagensPadronizadas {
	...
	public final String usernameJaCadastrado = "Username já cadastrado, por favor escolha outro username!";
	public final String emailJaCadastrado = "Email já cadastrado, por favor escolha outro email!";
	public final String loginErro = "Você não possui cadastro! Cadastre-se!";
	public final String loginSucesso = "Login efetuado com sucesso!";
